...
filetime=sys.argv[1]
filename="./data/post_rate_hour_master_"+filetime
...
plt.xlim(0,24)
plt.xticks(range(24))
plt.title(u"【主版本】peer连接成功率"+filetime,fontproperties=zhfont1)

plt.savefig("./png/post_hour_master_"+filetime)
print "draw"+filetime+" master hour png"
