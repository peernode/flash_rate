...
filetime=sys.argv[1]
filename="./data/seed_hour_beta_"+filetime
...
plt.xlim(0,24)
plt.xticks(range(24))
plt.title(u"【Beta版本】种子可做种率"+filetime,fontproperties=zhfont1)

plt.savefig("./png/seed_hour_beta_"+filetime)

print "draw"+filetime+" seed hour beta png"
